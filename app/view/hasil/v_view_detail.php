<body id="page-dashboard" class="page-dashboard crud">
    <?php require_once '/../part/header.php'; ?>
    <div id="main">
        <div class="container clearfix panduan">
            <div class="title"><i class="md md-folder"></i>Detail Hasil Uji Kualitas Kopi</div>
            <div class="card clearfix section">
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group clearfix">
                            <a class="btn btn-raised" href="<?php echo URL; ?>/hasil"><i class="md md-reply"></i>&nbsp;&nbsp;Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
